# build: docker build --no-cache --progress=plain --build-arg PHP_VERSION=8.4 -t tobi312/php:8.4-fpm-debian-wsc -f debian.fpm.wsc.Dockerfile .
ARG PHP_VERSION=8.4
...
LABEL org.opencontainers.image.authors="Tobias Hargesheimer <docker@ison.ws>" \
	...
	org.opencontainers.image.description="Debian with PHP ${PHP_VERSION} with FPM for WSC (WoltLab Suite Core)" \
