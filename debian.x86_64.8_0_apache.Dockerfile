...
LABEL org.opencontainers.image.authors="Tobias Hargesheimer <docker@ison.ws>" \
	...
	org.opencontainers.image.description="Debian with PHP8.0 and Apache2 on x86_64 arch" \
...
RUN dpkgArch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)" && echo "dpkgArch=${dpkgArch}"; \
	...
	docker-php-ext-install \
		...
		zip \
	; \
	# https://github.com/docker-library/php/issues/1049 & https://github.com/docker-library/php/issues/1029#issuecomment-650576137
	#pecl install ssh2; \
