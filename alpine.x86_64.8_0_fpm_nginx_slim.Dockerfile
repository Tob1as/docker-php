...
#		echo '<head><meta charset="utf-8"><meta name="generator" content="Docker Image: tobi312/php:8.0-fpm-nginx-slim"><title>Site</title></head>'; \
#		echo '<body><h1>Hello!</h1><p>This is a simple website.<br><?php echo date("Y-m-d H:i:s"); ?></p></body>'; \
#		echo '</html>'; \
